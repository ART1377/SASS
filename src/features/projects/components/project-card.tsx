...
import { CheckSquare, MoreVertical, Pencil, Trash2, Users } from 'lucide-react';
...
export function ProjectCard({ project, onEdit, onDelete }: ProjectCardProps) {
  return (
    <Card className="card-hover group relative overflow-hidden border-0 shadow-lg transition-all duration-300">
